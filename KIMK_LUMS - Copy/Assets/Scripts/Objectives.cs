...
public class Objectives : MonoBehaviour
{
    ...
    string[] obj = { "Talk to Roommate", "Exit to khoka","Talk to roommate","Interact with yourself","talk to roommate","Get ready","Exit to SSE","Acknowledge","Interact with yourself" };
    int current = 1;
